            ...
            <div className="col-sm-9 padding-right" >
                <div className="features_items">{/*features_items*/}
                    ...
                    <div className="product-image-wrapper">
                        ...
                        <div className="product-overlay">
                            ...
                            <form>
                                ...
                                <button type="submit" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart1111</button>
                            </form>
                            </div>
                        </div>
                        </div>
                    ...
                    <div className="product-image-wrapper">
                        ...
                        <img src="content/images/home/new.png" className="new" alt />
                        </div>
                        <div className="choose">
                        <ul className="nav nav-pills nav-justified">
                            <li><a href="#"><i className="fa fa-plus-square" />Add to wishlist</a></li>
                    ...
                    <div className="product-image-wrapper">
                        ...
                        <img src="content/images/home/sale.png" className="new" alt />
                        </div>
                        <div className="choose">
                        <ul className="nav nav-pills nav-justified">
                            <li><a href="#"><i className="fa fa-plus-square" />Add to wishlist</a></li>
                ...
                <div className="category-tab">{/*category-tab*/}
                    ...
                    <div className="tab-pane fade active in" id="tshirt">
                        ...
                        <div className="product-image-wrapper">
                            <div className="single-products">
                            <div className="productinfo text-center">
                                <img src="content/images/home/gallery1.jpg" alt />
                                <h2>$56</h2>
                                <p>Easy Polo Black Edition</p>
                                <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                            </div>
                        ...
                        <div className="product-image-wrapper">
                            <div className="single-products">
                            <div className="productinfo text-center">
                                <img src="content/images/home/gallery2.jpg" alt />
                                <h2>$56</h2>
                                <p>Easy Polo Black Edition</p>
                                <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                            </div>
                        ...
                        <div className="product-image-wrapper">
                            <div className="single-products">
                            <div className="productinfo text-center">
                                <img src="content/images/home/gallery3.jpg" alt />
                                <h2>$56</h2>
                                <p>Easy Polo Black Edition</p>
                                <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                            </div>
                        ...
                        <div className="product-image-wrapper">
                            <div className="single-products">
                            <div className="productinfo text-center">
                                <img src="content/images/home/gallery4.jpg" alt />
                                <h2>$56</h2>
                                <p>Easy Polo Black Edition</p>
                                <a href="#" className="btn btn-default add-to-cart"><i className="fa fa-shopping-cart" />Add to cart</a>
                            </div>
